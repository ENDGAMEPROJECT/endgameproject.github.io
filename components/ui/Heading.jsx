...
const Heading = ({ level = "h1", children, className }) => {
  ...
  const classes = clsx([
    ...
    {
      "text-36 sm:text-40 mt-8 mb-6 font-medium uppercase text-center text-primary": level === "h1",
      ...
      "text-base text-grey-100 sm:text-20 md:text-24 mb-2 max-w-[50ch] md:max-w-[70ch] 2xl:max-w-[75ch]": level === "subtitle",
    }, className,
  ]);
