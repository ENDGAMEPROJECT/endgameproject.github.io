export const events = [
  {
    ...
    title_fi: "ENDGAME julkaisee toisen opetuksellisen pakopelinsä tekoälyn tuottaman disinformaation ja ilmastodisinformaation tunnistamisesta",
    description_en: "",    
    description_sr: "",
    description_es: "",
    description_fi: "",    
...
<p>En España, hemos realizado una primera ronda de testeos en la Universidad Politécnica de Madrid en la que han participado 118 estudiantes de 4º de la ESO. El resultado de esta prueba piloto ha sido muy satisfactorio tanto cuantitativamente (los primeros análisis de los datos indican que los estudiantes han aprendido y mejorado su conciencia crítica) como cualitativamente (les ha gustado mucho el juego y la experiencia de usuario). Además, este mes de mayo, el equipo educativo de la Fundación Maldita.es estará también en Canarias probando el escape room con estudiantes de 2º de la ESO en el IES Santiago Santana Díaz, Gran Canaria.</p>
    `,
    htmlbody_fi: `
<p>Eurooppalainen hanke <b>ENDGAME</b> (Escaping New Disinformation through Gamified Cross-Border Media Literacy Education), jota koordinoi <b><a href="https://www.uef.fi/fi" target="_blank">Itä-Suomen yliopisto (UEF, Suomi)</a></b> ja johon osallistuvat <b><a href="https://www.upm.es/" target="_blank">Madridin teknillinen yliopisto (UPM, Espanja)</a></b>, <b><a href="https://www.metropolitan.ac.rs/en/about-metropolitan-university/" target="_blank">Belgradin metropoliamakorkeakoulu (BMU, Serbia)</a></b>, <b><a href="https://faktabaari.fi/in-english/" target="_blank">Faktabaari</a></b> (Suomi), <b><a href="https://novinarska-skola.org.rs/" target="_blank">Novi Sadin journalismikoulu (FNT, Serbia)</a></b> ja <b><a href="http://Maldita.es" target="_blank">Fundación Maldita.es</a></b> (Espanja), on kehittänyt toisen opetuksellisen pakopelinsä, <b><a href="https://endgameproject.github.io/ECHO/">"ECHO"</a></b>, sekä siihen liittyvän <b><a href="https://docs.google.com/document/d/1H5o44V-bTfQyyESSkgTDPV1M7TtjNYE_/export?format=pdf" target="_blank">opettajan oppaan</a></b>, joka on suunniteltu auttamaan kasvattajia käsittelemään medialukutaitoa, tekoälyä ja kriittistä ajattelua luokkahuoneessa ja muissa nuorten kanssa toimivissa oppimisympäristöissä. Molemmat resurssit ovat parhaillaan pilotoinnissa alueellisissa tapahtumissa ja kouluissa Espanjassa, Suomessa ja Serbiassa. Tämä on toinen kolmesta pakopelistä, jotka hanke kehittää vuosina 2025–2027.</p>
<br/>
<h2>Peli tekoälyn tuottaman disinformaation torjumiseksi</h2>

<p>"ECHO":ssa pelaajat ottavat sosiaalisen median sisältömoderaattorin roolin, jonka tehtävänä on pysäyttää kuvitteellisessa someverkossa leviävä ilmastodisinformaatioaalto. Pelin aikana nuorten on tunnistettava bottitilit, havaita tekoälyn tuottama sisältö ja arvioida, käytetäänkö tekoälyä vastuullisesti verkossa.</p>

<p>Noin 20 minuutin ajan pelaajat kohtaavat useita todellisiin verkkoilmiöihin perustuvia haasteita, kuten emotionaalisesti manipuloivia julkaisuja, epäilyttäviä sometiliä ja harhaanjohtavaa tekoälyn tuottamaa sisältöä. Peli rohkaisee osallistujia pohtimaan, miten somepalvelut toimivat, miten generatiiviset tekoälyjärjestelmät toimivat ja miten disinformaatio hyödyntää tunteita, kuten pelkoa tai raivoa, levitäkseen verkossa.</p>

<p>Pakopeli keskittyy erityisesti ilmastodisinformaatioon ja tekoälyn kasvavaan rooliin harhaanjohtavien narratiivien vahvistamisessa verkossa. Pelaamisen kautta pelaajat oppivat, miten suuret kielimallit toimivat, miksi tekoälyjärjestelmät voivat "hallusinoida" tai antaa epätarkkaa tietoa ja miksi verkkosisällön kriittinen tarkistaminen on edelleen välttämätöntä.</p>
<br/>
<h2>Opas pelin käyttöön oppimisympäristöissä</h2>

<p>Pakopelin mukana tulee <b><a href="https://docs.google.com/document/d/1H5o44V-bTfQyyESSkgTDPV1M7TtjNYE_/export?format=pdf" target="_blank">didaktinen opas</a></b>, joka tarjoaa opettajille taustatietoa generatiivisesta tekoälystä, sosiaalisen median moderoinnista, boteista ja ilmastodisinformaatiosta sekä toimintoja toteutettavaksi nuorten kanssa ennen peliä ja sen jälkeen. Opas sisältää myös käytännön harjoituksia, jotka auttavat osallistujia pohtimaan emotionaalista manipulointia, lähteiden tarkistamista ja tekoälyn vastuullista käyttöä.</p>
<br/>
<h2>Pelin käyttöönotto ja testaus nuorten kanssa Euroopassa</h2>

<p>Parhaillaan "ECHO"-peliä testataan pilottikokeiluissa kouluissa ja alueellisissa tapahtumissa Suomessa, Serbiassa ja Espanjassa palautteen keräämiseksi ja kokemuksen parantamiseksi. Hanke odottaa tavoittavansa yli 500 nuorta kolmessa maassa. Lisäksi peli on saatavilla <b><a href="https://endgameproject.github.io/ECHO/">hankkeen verkkosivuilla</a></b> englanniksi, espanjaksi, serbiaksi ja suomeksi, jotta sitä voidaan pelata virtuaalisesti ja lisätä pakopelin vaikutusta koko Euroopassa.</p>
    `,
    externalLinkJoin: "",
